...
// // export const parseAndCreateRule = async (req: Request, res: Response) => {
// //     try {
...
// //       const saved = await service.parseAndSave(prompt, tenant_id as string);
// //       return res.status(200).json({ status: 200, data: saved.rule });
// //     } catch (err: any) {
...
// //       return res.json({ status: 200, events });
// //     } catch (err: any) {
// //       return res.status(500).json({ error: err.message });
// //     }
// //   };
